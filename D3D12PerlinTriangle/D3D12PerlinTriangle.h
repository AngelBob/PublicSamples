...
class D3D12PerlinTriangle : public DXSample
{
public:
    D3D12PerlinTriangle(UINT width, UINT height, std::wstring name);
...
private:
    ...
    void CreateBackgroundPSO();
    void LoadPipeline();
    void LoadAssets();
    std::vector<UINT8> GenerateTextureData();
    std::vector<UINT8> GeneratePerlinTextureData();
